...
--
-- Host: localhost
-- Generation Time: Mar 02, 2018 at 09:02 AM
...
CREATE TABLE `tbl_user` (
  ...
  `tbl_third` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_level`, `user_ip`, `tbl_third`) VALUES
(16, 'Peter', 'ding', 'sdddd', 'dingjingwen1234@gmail.com', '2018-03-02 07:56:02', '', '::1', '1'),
(17, '3', '3', '3', '3', '2018-03-02 07:57:54', '2', '::1', '1'),
(18, 'Peter', 'Ma', '1234', 'dingjingwen@gmail.com', '2018-03-02 08:01:41', '', 'no', NULL);
...
--
ALTER TABLE `tbl_user`
  MODIFY `user_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
